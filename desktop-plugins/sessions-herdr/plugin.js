/**
 * sessions-herdr — Hop B thin Sessions shell (Herdr-inside-Desktop).
...
function SessionsPage(props) {
  ...
  useEffect(function () {
    ...
    const t = setInterval(refreshGatewayStatuses, POLL_MS)
  ...
  function onCreate() {
    ...
    setForm(emptyForm())
    setNote('created ' + sess.id + ' → kanban=' + sess.kanbanId + ' run=' + sess.runId + ' herdr=' + sess.herdrId)
    haptic('tap')
          ...
          jsxs('div', {
            children: [
              ...
              jsx('div', {
                ...
                children: 'Herdr-inside-Desktop · Hop B shell · not a second board'
              })
            ]
          }),
          jsx('div', {
        ...
        children: [
          ...
          sessions.length === 0
            ? jsx('div', {
                ...
                children: 'Empty · Abrí un agente en Sessions (create above)'
              })
            : null
        ]
      }),
          ...
          return jsxs('div', {
            ...
            children: [
              ...
              jsx('div', {
                ...
                children: 'id=' + s.id + ' · kanban=' + s.kanbanId + ' · run=' + s.runId + ' · herdr=' + s.herdrId
              }),
...
export default {
  id: ID,
  name: 'Sessions (Herdr)',
  description: 'Thin Sessions shell — create-time link; gateway owns status. Not a second board.',
  defaultEnabled: true,
  register(ctx) {
    ctx.registerMany([
      {
